        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div>
                ...
                <input type="text"
                       id="title"
                       wire:model="title"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('title') border-red-500 @enderror"
            ...
            <div>
                ...
                <input type="text"
                       id="company"
                       wire:model="company"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('company') border-red-500 @enderror"
            ...
            <div>
                ...
                <input type="text"
                       id="location"
                       wire:model="location"
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('location') border-red-500 @enderror"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="work_type"
                            ...
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('work_type') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <select id="job_type"
                            wire:model="job_type"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('job_type') border-red-500 @enderror">
            ...
            <div>
                ...
                <input type="text"
                       ...
                       class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('salary_range') border-red-500 @enderror"
            ...
            <div>
                ...
                <textarea id="requirements"
                          ...
                          rows="6"
                          class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('requirements') border-red-500 @enderror"
