            ...
            <div class="relative bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 text-white p-8 rounded-t-lg overflow-hidden">
                <div class="flex items-start space-x-6">
                    ...
                    <div class="flex-shrink-0">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($jobsapply?->full_name) }}&size=120&background=4f46e5&color=ffffff&bold=true"
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xl text-blue-200 mb-3">Candidate for {{ $jobsapply?->job?->title }}</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ $jobsapply->linkedin_url }}" target="_blank" class="hover:text-blue-200 underline">LinkedIn Profile</a>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ $jobsapply->portfolio_url }}" target="_blank" class="hover:text-blue-200 underline">Portfolio</a>
                            </div>
                            @endif
                        </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="{{ $jobsapply->linkedin_url }}" target="_blank" class="text-blue-600 hover:underline font-medium">
                                    LinkedIn Profile
                                </a>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="{{ $jobsapply->portfolio_url }}" target="_blank" class="text-orange-600 hover:underline font-medium">
                                    Portfolio Website
                                </a>
                            </div>
                            @endif
                    ...
                    <section>
                        ...
                        <div class="space-y-2 text-sm">
                            <div>
                                ...
                                <span class="font-medium text-gray-900 dark:text-white">{{ $jobsapply?->job?->title }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600 dark:text-gray-300">Company: </span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $jobsapply?->job?->company }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600 dark:text-gray-300">Location: </span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $jobsapply?->job?->location }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600 dark:text-gray-300">Application Date: </span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $jobsapply?->created_at?->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div class="space-y-2 text-sm">
                            <div>
                                ...
                                <span class="font-medium text-green-600 dark:text-green-400">RM {{ number_format($jobsapply?->expected_salary ?: 0) ?: 'Negotiable' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600 dark:text-gray-300">Available Start: </span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $jobsapply?->available_start_date?->format('M d, Y') ?: 'Not specified' }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600 dark:text-gray-300">Willing to Relocate: </span>
                                <span class="font-medium {{ $jobsapply?->willing_to_relocate ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
