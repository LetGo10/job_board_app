<div>
    ...
    <!-- Jobs List -->
        <!--[if BLOCK]><![endif]--><?php if($jobs->count() > 0): ?>
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center gap-3">
                                    <div>
                                        <div class="font-medium text-gray-900 dark:text-white"><?php echo e($job->title); ?></div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($job->company); ?></div>
                                    </div>
                                </div>
                            </th>
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900 dark:text-white">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                        <?php echo e(ucfirst(str_replace('-', ' ', $job->job_type ?? 'N/A'))); ?>
                            ...
                            <td class="px-6 py-4">
                                <!--[if BLOCK]><![endif]--><?php if($job->status === 'pending'): ?>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center items-center space-x-2">
                                    <!--[if BLOCK]><![endif]--><?php if($job->status === 'pending'): ?>
                                        <button wire:click="confirmActivate(<?php echo e($job->id); ?>)"
                                    ...
                                    <button wire:click="$dispatch('openJobView', { jobId: <?php echo e($job->id); ?> })" title="View Job" class="p-2 text-white bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:outline-none rounded-full transition-all duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="<?php echo e(route('edit-job', $job->id)); ?>" title="Edit Job" class="p-2 text-white bg-gray-600 hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:outline-none rounded-full transition-all duration-200 inline-block">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-data="{ open: <?php if ((object) ('showActivateModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showActivateModal'->value()); ?>')<?php echo e('showActivateModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showActivateModal'); ?>')<?php endif; ?> }" x-cloak>
        <div x-show="open"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6 z-10">
                ...
                <div class="mb-6">
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
                        Ready to make your job visible to candidates? Complete payment to activate your job posting and start receiving applications.
                    </p>
        ...
        <div x-show="open"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6 z-10">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button wire:click="confirmDeleteJob"
                            wire:loading.attr="disabled"
                        ...
                        <span wire:loading.remove wire:target="confirmDeleteJob">Delete Job</span>
                        <span wire:loading wire:target="confirmDeleteJob" class="flex items-center">
                            <svg class="w-4 h-4 mr-2 animate-spin" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
...
<?php /**PATH C:\Users\OUM\Herd\job-board-app-2\resources\views/livewire/my-job-posts.blade.php ENDPATH**/ ?>