                            ...
                            <div class="border border-gray-200 rounded-lg p-4 bg-gray-50"
                                ...
                                <div class="flex items-center mb-3">
                                    ...
                                    <span class="ml-2 px-2 py-1 text-xs rounded-full
                                        <?php if($currentPrompt->status === 'Pending'): ?> bg-yellow-100 text-yellow-800
                                        <?php elseif($currentPrompt->status === 'Completed'): ?> bg-green-100 text-green-800
                                ...
                                <?php elseif($currentPrompt->status === 'Completed'): ?>
                                    <div>
                                        ...
                                        <div class="bg-white p-3 rounded border text-sm max-h-48 overflow-y-auto">
                                            <pre class="whitespace-pre-wrap text-gray-900"><?php echo $currentPrompt->getFormattedResponse(); ?></pre>
                                        </div>
                                    </div>
...
<?php /**PATH C:\Users\OUM\Herd\job-board-app-2\resources\views/livewire/ai-description-modal.blade.php ENDPATH**/ ?>