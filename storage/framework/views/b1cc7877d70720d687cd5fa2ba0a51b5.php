    ...
    >
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                        ...
                        Posted on <?php echo e($job?->created_at->format('F j, Y')); ?>
            ...
            <div class="flex items-center justify-end p-6 border-t border-gray-200 dark:border-gray-700 space-x-3">
                ...
                <button wire:click="applyForJob(<?php echo e($job?->id); ?>)"
...
<?php /**PATH C:\Users\OUM\Herd\job-board-app-2\resources\views/livewire/job-view.blade.php ENDPATH**/ ?>