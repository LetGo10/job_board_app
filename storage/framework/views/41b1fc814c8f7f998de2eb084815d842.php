    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-600 hover:text-purple-700">Home</a></li>
                    <li><a href="<?php echo e(route('jobs')); ?>" class="text-sm text-gray-600 hover:text-purple-700">Jobs</a></li>
                    <li><a href="<?php echo e(route('companies')); ?>" class="text-sm text-gray-600 hover:text-purple-700">Companies</a></li>
                </ul>
            </div>
...
<?php /**PATH C:\Users\OUM\Herd\job-board-app-2\resources\views/components/footer.blade.php ENDPATH**/ ?>