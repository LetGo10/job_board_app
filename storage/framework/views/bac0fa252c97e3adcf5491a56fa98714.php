<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <div class="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-2xl shadow hover:shadow-lg transition text-center">
            ...
            <p class="mt-3 text-3xl font-extrabold text-gray-800"><?php echo e($totalJobs ?? 0); ?></p>
        ...
        <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 p-6 rounded-2xl shadow hover:shadow-lg transition text-center">
            ...
            <p class="mt-3 text-3xl font-extrabold text-gray-800"><?php echo e($totalJobsApply ?? 0); ?></p>
        ...
        <div class="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-2xl shadow hover:shadow-lg transition text-center">
            ...
            <p class="mt-3 text-3xl font-extrabold text-gray-800"><?php echo e(\App\Models\User::count() ?? 0); ?></p>
        ...
        <div class="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-2xl shadow hover:shadow-lg transition text-center">
            ...
            <p class="mt-3 text-3xl font-extrabold text-gray-800"><?php echo e(\App\Models\JobApplication::whereDate('created_at', today())->count() ?? 0); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition lg:col-span-2">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('job.application')); ?>" class="text-sm text-indigo-600 hover:text-indigo-800">
                    View All →
                </a>
            </div>
            ...
            <!--[if BLOCK]><![endif]--><?php if($recentApplications->count() > 0): ?>
                <div class="space-y-3">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center gap-3">
                                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($application->full_name)); ?>&size=40&background=random"
                                     alt="<?php echo e($application->full_name); ?>" class="w-10 h-10 rounded-full">
                                <div>
                                    <h4 class="font-medium text-gray-800"><?php echo e($application->full_name); ?></h4>
                                    <p class="text-sm text-gray-600"><?php echo e($application->job->title ?? 'Job Title'); ?></p>
                                </div>
                            </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition">
            ...
            <div class="space-y-3">
                ...
                <a href="<?php echo e(route('companies')); ?>"
...
<?php /**PATH C:\Users\OUM\Herd\job-board-app-2\resources\views/livewire/admin-dashboard.blade.php ENDPATH**/ ?>