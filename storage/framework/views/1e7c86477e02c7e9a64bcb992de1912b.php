    ...
    <div x-show="showModal"
        ...
        <div x-transition:enter="transition-all duration-600 ease-out delay-100"
            ...
            <div class="p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <div class="flex items-center justify-center text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        <span>Posted on <?php echo e($job?->created_at?->format('F j, Y')); ?></span>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 mb-8">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($job?->company)); ?>&size=64&background=random"
                                 alt="<?php echo e($job?->company); ?>" class="w-16 h-16 rounded-full border-4 border-white shadow-lg">
                            <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    ...
                    <div class="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        ...
                        <p class="font-semibold text-gray-900 dark:text-white"><?php echo e(ucfirst(str_replace('-', ' ', $job?->job_type))); ?></p>
                    </div>
                    ...
                    <div class="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                        ...
                        <p class="font-semibold text-gray-900 dark:text-white"><?php echo e(ucfirst(str_replace('-', ' ', $job?->work_type))); ?></p>
                    </div>
                    ...
                    <div class="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        ...
                        <?php else: ?>
                            <p class="font-semibold text-gray-700 dark:text-gray-300"><?php echo e(ucfirst($job?->status)); ?></p>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>

                    <!-- Salary -->
                    <!--[if BLOCK]><![endif]--><?php if($job?->salary_range): ?>
                    <div class="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                        ...
                        <p class="font-semibold text-gray-900 dark:text-white text-sm"><?php echo e($job?->salary_range); ?></p>
                    </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                ...
                <!-- Requirements -->
                <!--[if BLOCK]><![endif]--><?php if($job?->requirements): ?>
                <div class="mb-6">
                    <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">
                        Requirements
                    </h4>
            ...
            <div class="flex items-center justify-end p-6 border-t border-gray-200 dark:border-gray-700 space-x-3">
                ...
                <!--[if BLOCK]><![endif]--><?php if($job?->status === 'pending'): ?>
                <button wire:click="$dispatch('activateJobFromModal', { jobId: <?php echo e($job?->id); ?> })"
...
<?php /**PATH C:\Users\OUM\Herd\job-board-app-2\resources\views/livewire/view-my-job-posts.blade.php ENDPATH**/ ?>