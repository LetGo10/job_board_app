                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            <td class="px-6 py-4">
                                <div>
                                    ...
                                    <div class="text-xs text-gray-400 dark:text-gray-500"><?php echo e($job->location); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm">
                                    <div class="font-medium text-gray-900 dark:text-white"><?php echo e($job->user->name ?? 'N/A'); ?></div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($job->user->email ?? 'N/A'); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                                <?php echo e($job->created_at->format('M j, Y')); ?>
...
<?php /**PATH C:\Users\OUM\Herd\job-board-app-2\resources\views/livewire/admin-job-management.blade.php ENDPATH**/ ?>