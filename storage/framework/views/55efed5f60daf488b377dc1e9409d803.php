        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center mb-6">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($user?->name)); ?>&size=80&background=3B82F6&color=ffffff&bold=true"
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                        ...
                        Joined on <?php echo e($user?->created_at?->format('F j, Y')); ?>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                            <div class="text-2xl font-bold text-green-600 dark:text-green-400">
                                <?php echo e($user?->jobApplications?->count() ?? 0); ?>
...
<?php /**PATH C:\Users\OUM\Herd\job-board-app-2\resources\views/livewire/user-profile-view.blade.php ENDPATH**/ ?>